...
@section('title', __('global.Service'))
                ...
                <div class="col-lg-5" data-aos="fade-left" data-aos-delay="200">
                    <div class="product-details">
                        ...
                        <h1 class="product-name  {{ app()->getLocale() == 'ar' ? 'text-end' : 'text-start' }}">
                            {{ app()->getLocale() == 'ar' ? $service->name_ar : $service->name_en }}</h1>
                        ...
                        <div class="product-description">
                            <p class="{{ app()->getLocale() == 'ar' ? 'text-end' : 'text-start' }}">
                                {{ app()->getLocale() == 'ar' ? $service->description_ar : $service->description_en }} </p>
                        </div>
                        <!-- Product Variants -->
                        <div class="purchase-section">
                            ...
                            <div
                                ...
                                <button class="btn primary-action order_now" id="order_now" data-id="{{ $service->id }}">
                                    <i class="bi bi-bag-plus"></i>
                                    @lang('global.order_now')
                                </button>
                                <button class="btn secondary-action buy_now" id="buy_now" data-id="{{ $service->id }}">
                                    ...
                                    <div class="row g-4">
                                        <div
                                            ...
                                            <div class="content-section">
                                                ...
                                                <p> {{ app()->getLocale() == 'ar' ? $service->description_ar : $service->description_en }}
                                                </p>
                                            </div>
                                        </div>
